            ...
            <div className="row g-4 mb-5">
                    ...
                    <div className="glass-card h-100 p-0">
                        <div className="p-4">
                            <div className="d-flex align-items-center mb-4">
                                <FaLightbulb className="text-warning me-3 fs-3" />
                                <h3 className="h4 text-primary mb-0">How It Works</h3>
                            </div>
                ...
                >
                    <div className="glass-card h-100 p-0">
                        <div className="p-4">
                            <div className="d-flex align-items-center mb-4">
                                <FaTerminal className="text-accent-primary me-3 fs-3" />
                                <h3 className="h4 text-primary mb-0">Use Cases</h3>
                            </div>
            ...
            >
                <div className="col-lg-10">
                    <div className="glass-panel p-0 overflow-hidden">
                        <div className="p-3 bg-dark border-bottom border-secondary d-flex align-items-center">
